...
import LeftAndRightContentSubsectionHeader from './LeftAndRightContentSubsectionHeader';
...
const routes = (
  <div>
    ...
    <Route path="/tests/header-tests/left-and-right-content-subsection" component={LeftAndRightContentSubsectionHeader} />
  </div>
);
